...
export default function TreatmentCard({ treatment, index, locale }: TreatmentCardProps) {
  ...
  return (
    <article
      dir={isAr ? 'rtl' : 'ltr'}
      className="group shrink-0 mr-[48px] w-[300px] lg:w-[620px] bg-[#f9f4f0] rounded-[24px] p-[12px] lg:p-[16px] flex flex-col lg:flex-row lg:items-stretch gap-[16px] lg:gap-[28px] select-none transition-colors duration-500 ease-out hover:bg-[#f1e4d6]"
    >
